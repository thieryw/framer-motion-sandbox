...
export type Animation = boolean | AnimationControls | TargetAndTransition | VariantLabels | undefined;

export type Initial = boolean | MakeCustomValueType<TargetProperties> | VariantLabels | undefined;
